      ...
      <Card className="overflow-hidden group card-hover animate-fade-in relative">
        ...
        <CardContent className="p-4 relative z-10">
          <div className="flex items-center gap-4">
            <Link to={`/market/${listing.id}`} className="block group-hover:scale-105 transition-transform duration-300">
              <div className="w-28 h-24 rounded bg-muted/30 overflow-hidden shadow-sm group-hover:shadow-md transition-shadow duration-300">
                {imageSrc ? (
                  <img src={imageSrc} alt={listing.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                ) : (
          ...
          <div className="flex items-center justify-between text-sm text-muted-foreground">
            ...
            <Link 
              ...
              className="flex items-center gap-2 truncate hover:underline hover:text-primary transition-colors"
            ...
            <div className="text-right flex flex-col gap-2">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  disabled={!currentUser || currentUser.uid === listing.sellerId}
                >
        ...
        <DirectMessagesModal
          ...
          initialRecipientId={listing.sellerId}
        />
      </Card>
    );
  }
  ...
  return (
    <Card className="overflow-hidden group card-hover animate-fade-in relative">
      ...
      <CardContent className="p-0 relative z-10">
        <Link to={`/market/${listing.id}`} className="block overflow-hidden">
        ...
        <div className="p-4 space-y-2">
          ...
          <div className="flex items-center justify-between pt-2">
            <Link 
              to={`/seller/${listing.sellerId}`}
              className="flex items-center gap-2 text-xs text-muted-foreground group-hover:text-foreground transition-colors duration-300 hover:underline"
              onClick={(e) => e.stopPropagation()}
            >
